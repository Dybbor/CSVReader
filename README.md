 Main - исходники программы, которая считывает файл с командной строки, считает все формулы и печатает результат на экран. Формулы должны иметь определенный вид "=ARG1 OP ARG2", где OP это + - * /
